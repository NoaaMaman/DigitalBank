...
contract BankAccount{
    ...
    event WithdrawRequested(address indexed userm,
                  uint indexed accountID,
    ...
    modifier canApprove(uint accountId, uint withdrawId){
        ...
        require(
            !accounts[accountId].withdrawRequests[withdrawId].ownerApproved[msg.sender],
    ...
    function approvalWithdrawl(uint accountId, uint withdrawId) 
        external
        accountOwner(accountId)
